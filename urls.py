...
urlpatterns = patterns('',
    ...
    url(r'^login$', 'descgen.views.auth.login', {'template_name': 'login.html'}, name='login'),
    url(r'^logout$', 'descgen.views.auth.logout', {'template_name': 'logged_out.html'}, name='logout'),
