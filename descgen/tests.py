...
class DiscogsTest(TestCase):
    ...
    def test_featuring_track_artist_in_artist_column(self):
        ...
        release_event = expected.create_release_event()
        release_event.set_date('2014')
        release_event.set_country('Portugal')
        expected.append_release_event(release_event)
        ...
        expected.append_genre('Electronic')
        expected.append_genre('Latin')
        expected.append_genre('Pop')
        expected.append_genre('Folk')
        expected.append_genre('World')
        expected.append_genre('Country')

        expected.append_style('African')
        expected.append_style('Electro House')
        expected.append_style('Forro')
        expected.append_style('Latin')
        expected.append_style('House')

        expected.set_url('http://www.discogs.com/Various-Caribe-Grande-%C3%8Axitos-2014/release/5586877')
        ...
        track = disc.create_track()
        track.set_number('1')
        track.set_title('Show Das Poderosas')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Kelly Pink')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('2')
        track.set_title("Me Agarra So' No Uhm")
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Landrick')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Pedro Amorim')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('David Miks')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.FEATURING)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('4')
        track.set_title('Menina Loka')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Jey V')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('MC Y2K')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.FEATURING)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Tayla Riddel')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name("Johne D'luka")
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('7')
        track.set_title('Bam Bam Bam')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Rogerinho')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('8')
        track.set_title('Vem A Mi')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('DJ Bheaven')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('10')
        track.set_title('We Gonna Party')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Pedro Amorim')
        track_artist.set_various(False)
        ...
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Daduh King')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.FEATURING)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Gao Percussion')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.FEATURING)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Mc Bola')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Mc Rodriguez')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.FEATURING)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('13')
        track.set_title('Vamos Zuar')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Bryan Wilson')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Sebastian Crayn')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        ...
        track = disc.create_track()
        track.set_number('14')
        track.set_title('Bailando Asi')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('DJ BodySoul')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Hugo Bessa')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Jay Laroye')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Stape')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.FEATURING)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Carlitos Rossy')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Pipe Calderon')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('El Cata')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Nova La Amenaza')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        ...
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('3 Beatz Muzik')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('18')
        track.set_title('Bailando')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Mike Moonnight')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Mark F')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Vic J')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.FEATURING)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Alex B')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.FEATURING)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('19')
        track.set_title('Noche De Fiesta')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Jose Delgado')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        ...
        track = disc.create_track()
        track.set_number('20')
        track.set_title('Beijo Bom')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Hallux')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Marcus')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.FEATURING)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Lilian Raquel')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.FEATURING)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('1')
        track.set_title('Trair A Minha Namorada (Hoje Eu Quero Trair) (DJ Bruno F Remix)')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('MC Ricardo')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('DJ Bruno F')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.REMIXER)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Taty Agressivo')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.FEATURING)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('3')
        track.set_title('Bango')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Jay Lima')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('4')
        track.set_title('Otro Dia (Mastkisoul Remix)')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Gregor Salto')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Kit (Kuenta / Tambu)')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.FEATURING)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Mastiksoul')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.REMIXER)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('5')
        track.set_title('Mina Loca')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Bodytalk')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('DJ Tiago')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Pm Akordeon')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.FEATURING)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Thiago Martins')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.FEATURING)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('6')
        track.set_title('I Found You (The Spacemakers Dirty Radio Edit)')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Bryan Wilson')
        track_artist.set_various(False)
        ...
        track = disc.create_track()
        track.set_number('8')
        track.set_title('Morena (Massivedrum Remix)')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Franklin Rodriques')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('William')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.FEATURING)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Massivedrum')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.REMIXER)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('9')
        track.set_title('Stronger (DJ Bruno F Radio Edit)')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Da Fonseca')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Jay Lion')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Daniela Pimenta')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.FEATURING)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Bruno Soares Sax')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.FEATURING)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        ...
        track = disc.create_track()
        track.set_number('10')
        track.set_title('Xibita (DJ Mike C Radio Edit)')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Meith')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Y.a.m.a')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Mc Guy H.')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.FEATURING)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('DJ Mike C')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.REMIXER)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('11')
        track.set_title('Africanism')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Alvaro Corz')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Bryan Dalton')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('13')
        track.set_title('Te Voy Amar (Soul Beatz Remix)')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('DJ Pedrito')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        ...
        track = disc.create_track()
        track.set_number('14')
        track.set_title('Players')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Brian Chundro')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Santos')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Marlldexx')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('15')
        track.set_title('Vem Rebolando')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('James Noyer')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('16')
        track.set_title('Vale A Pena 2k14')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('D-Rashid')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Praia Del Sol')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Glowinthedark')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Chuckie')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.FEATURING)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('1')
        track.set_title('Mila')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Banda Mar Azul')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('2')
        track.set_title('Canto Da Cidade')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Banda Mar Azul')
        track_artist.set_various(False)
        ...
        track = disc.create_track()
        track.set_number('4')
        track.set_title('Chorando Se Foi')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Bahia Tropical')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('7')
        track.set_title('Sorte Grande')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Bahia Pagode Tropical')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('8')
        track.set_title('Saia E Bicicletinha')
        track.set_length(None)
        track_artist = expected.create_artist()
        ...
        track = disc.create_track()
        track.set_number('11')
        track.set_title('Pout-Pourri 1')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Unknown Artist')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('13')
        track.set_title('Pout-Pourri 3 (Marchas)')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Unknown Artist')
        track_artist.set_various(False)
        ...
        track = disc.create_track()
        track.set_number('16')
        track.set_title('Los Mayos- Disco Samba')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Unknown Artist')
        track_artist.set_various(False)
        ...
        s = discogs.ReleaseScraper.from_string('http://www.discogs.com/Various-Caribe-Grande-%C3%8Axitos-2014/release/5586877')
        r = s.get_result()
    ...
    def test_featuring_in_artist_and_track_column(self):
        ...
        release_event = expected.create_release_event()
        release_event.set_date('20 Nov 1996')
        release_event.set_country('Germany')
        expected.append_release_event(release_event)
        ...
        expected.set_title('Dream Dance Vol. 3')
        ...
        expected.set_url('http://www.discogs.com/Various-Dream-Dance-Vol-3/release/135664')
        ...
        track = disc.create_track()
        track.set_number('1')
        track.set_title('Salva Mea (Radio Edit)')
        track.set_length(224)
        track_artist = expected.create_artist()
        track_artist.set_name('Faithless')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('2')
        track.set_title('A Neverending Dream (Dream Dance Anthem Mix)')
        track.set_length(221)
        track_artist = expected.create_artist()
        track_artist.set_name('Trance X')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('3')
        track.set_title('7 Seconds (Radio-Video-Single)')
        track.set_length(248)
        track_artist = expected.create_artist()
        track_artist.set_name('Nomansland')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('4')
        track.set_title('One And One (Space Edit)')
        track.set_length(218)
        track_artist = expected.create_artist()
        track_artist.set_name('Ronald Snypes')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('5')
        track.set_title('Sweet Memories (Radio Edit)')
        track.set_length(234)
        track_artist = expected.create_artist()
        track_artist.set_name('Groove Solution')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('6')
        track.set_title('Fall Down On Me (Zhi-Vago In Mission Radio Edit)')
        track.set_length(245)
        track_artist = expected.create_artist()
        track_artist.set_name('Solid')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Zhi-Vago')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.REMIXER)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('7')
        track.set_title('Cybertrance')
        track.set_length(252)
        track_artist = expected.create_artist()
        track_artist.set_name('Blue Alphabet')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('8')
        track.set_title('Beautiful Place (Airwaves Mix)')
        track.set_length(204)
        track_artist = expected.create_artist()
        track_artist.set_name('Paul van Dyk')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track.set_length(249)
        track_artist = expected.create_artist()
        track_artist.set_name('Terra Ferma')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('10')
        track.set_title('The Nighttrain (Dream Station Remix)')
        track.set_length(369)
        track_artist = expected.create_artist()
        track_artist.set_name('Kadoc')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('11')
        track.set_title('Silencer I (Extended Mix)')
        track.set_length(336)
        track_artist = expected.create_artist()
        track_artist.set_name('DJ The Crow')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('13')
        track.set_title('Masterpiece')
        track.set_length(238)
        track_artist = expected.create_artist()
        track_artist.set_name('P-Casso')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('14')
        track.set_title('My Dimension (Radio Edit)')
        track.set_length(205)
        track_artist = expected.create_artist()
        track_artist.set_name('DJ Panda')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('15')
        track.set_title('Secret World (Radio Mix)')
        track.set_length(222)
        track_artist = expected.create_artist()
        track_artist.set_name('Vector Mode')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('16')
        track.set_title('Secret Love (Single Edit)')
        track.set_length(234)
        track_artist = expected.create_artist()
        track_artist.set_name('Magnetic Pulstar')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('17')
        track.set_title('Atlanta (Sunshine State Club Extravaganza)')
        track.set_length(402)
        track_artist = expected.create_artist()
        track_artist.set_name('Sunshine State')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Snake Davis')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.FEATURING)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track.set_length(236)
        track_artist = expected.create_artist()
        track_artist.set_name('M.R.')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('JPO & Beam')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.REMIXER)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('1')
        track.set_title('Up To No Good (Radio Edit)')
        track.set_length(210)
        track_artist = expected.create_artist()
        track_artist.set_name('Porn Kings')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('2')
        track.set_title('Reality (Too Short Video Radio)')
        track.set_length(231)
        track_artist = expected.create_artist()
        track_artist.set_name('RMB')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track.set_length(204)
        track_artist = expected.create_artist()
        track_artist.set_name('Futura Nostra')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('5')
        track.set_title('Love And Fate (Part 2)')
        track.set_length(296)
        track_artist = expected.create_artist()
        track_artist.set_name('Love And Fate')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('6')
        track.set_title('Go (Woodtick Mix)')
        track.set_length(323)
        track_artist = expected.create_artist()
        track_artist.set_name('Moby')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('7')
        track.set_title('Waters (Phase 2)')
        track.set_length(320)
        track_artist = expected.create_artist()
        track_artist.set_name('Taucher')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('8')
        track.set_title('Do You See The Light (Dance 2 Trance Mix)')
        track.set_length(481)
        track_artist = expected.create_artist()
        track_artist.set_name('Snap!')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Dance 2 Trance')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.REMIXER)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('9')
        track.set_title('Right In The Night (Fall In Love With Music) (Microbots Remix)')
        track.set_length(383)
        track_artist = expected.create_artist()
        track_artist.set_name('Jam & Spoon')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Plavka')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.FEATURING)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Microbots')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.REMIXER)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('10')
        track.set_title('Te Quierro (Trance Mix)')
        track.set_length(331)
        track_artist = expected.create_artist()
        track_artist.set_name('Intrance Feat. D-Sign')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('11')
        track.set_title('Hablando (Acordeon Mix)')
        track.set_length(391)
        track_artist = expected.create_artist()
        track_artist.set_name('Ramirez')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Pizarro')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.FEATURING)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track.set_length(240)
        track_artist = expected.create_artist()
        track_artist.set_name('Yves Deruyter')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Marusha')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.REMIXER)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('14')
        track.set_title('Rock Your Body (Radio Mix)')
        track.set_length(221)
        track_artist = expected.create_artist()
        ...
        track.set_length(228)
        track_artist = expected.create_artist()
        track_artist.set_name('DJ Hooligan')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('16')
        track.set_title('Rhapsody In E')
        track.set_length(363)
        track_artist = expected.create_artist()
        track_artist.set_name('Scooter')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        s = discogs.ReleaseScraper.from_string('http://www.discogs.com/Various-Dream-Dance-Vol-3/release/135664')
        r = s.get_result()
    ...
    def test_multiple_special_arists_for_same_track(self):
        ...
        expected.set_title('Pure Silk: The Third Dimension')
        ...
        expected.append_style('UK Garage')

        expected.set_url('http://www.discogs.com/Various-Pure-Silk-The-Third-Dimension/release/463634')
        ...
        track = disc.create_track()
        track.set_number('1')
        track.set_title('Sunshine (Wookie Main Mix)')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Gabrielle')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Wookie')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.REMIXER)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('2')
        track.set_title('Baby Gonna Rock Dis (Original Mix)')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Chris Mack')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('MC Nuts')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.FEATURING)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('3')
        track.set_title('Girls Like Us')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('B-15 Project')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Crissy D')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.FEATURING)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Lady G')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.FEATURING)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('4')
        track.set_title('Streetlife (Original 12" Mix)')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Daryl B')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Mark Yardley')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('6')
        track.set_title('Everybody Come On (Stanton Warriors Remix)')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('DJ Skribble')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Stanton Warriors')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.REMIXER)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('7')
        track.set_title('Get Loose')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('DJ Double G')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('8')
        track.set_title('Right Before My Eyes (The Remix)')
        track.set_length(None)
        track_artist = expected.create_artist()
        ...
        track = disc.create_track()
        track.set_number('9')
        track.set_title('What Ya Gonna Do')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Artful Dodger')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('702')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Marvel & Eli')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.REMIXER)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('12')
        track.set_title('Spirit Of The Sun (Bump & Flex Remix)')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Lenny Fontana')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Bump & Flex')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.REMIXER)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('13')
        track.set_title('Celebrate Life (Zed Bias Vocal Mix)')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Brasstooth')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Sean Mitchell')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.FEATURING)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Zed Bias')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.REMIXER)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('15')
        track.set_title('Glad You Came To Me (Steve Gurley VIP Mix)')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('United Grooves Collective')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Steve Gurley')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.REMIXER)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('16')
        track.set_title('Find The Path (Sweet Release Mix)')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('New Horizons')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('17')
        track.set_title('Give Some To Me (Masterplan)')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Suiceyed')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('18')
        track.set_title('That Sound')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Michael Moog')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('1')
        track.set_title('Sweeter Than Wine')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Dionne Rakeem')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Dreem House Productions')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.REMIXER)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('MC Rumpus')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.FEATURING)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('4')
        track.set_title('Madness On The Street')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Richie Boy')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('DJ Klasse')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Basement Jaxx')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        ...
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Jocelyn Brown')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        ...
        track = disc.create_track()
        track.set_number('7')
        track.set_title('Let Me Know')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('K.C.')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        ...
        track = disc.create_track()
        track.set_number('8')
        track.set_title('For Real')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('M Dubs')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('J.P.')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('9')
        track.set_title('Tingles 2000 (Zed Bias Remix)')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Valerie M')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        ...
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Dreem Teem')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('Neneh Cherry')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('11')
        track.set_title('Apparently Nothing (Artful Dodger Mix)')
        track.set_length(None)
        track_artist = expected.create_artist()
        ...
        track = disc.create_track()
        track.set_number('12')
        track.set_title('Sometimes It Snows In April (Dreem House Dub Mix)')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Amar')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name('MC Ranking')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.FEATURING)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        ...
        track = disc.create_track()
        track.set_number('14')
        track.set_title('Hold Me Tight')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('DJ Lewi')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('15')
        track.set_title('Beautiful (Dreem House Dub Mix)')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Groove Control')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        ...
        track = disc.create_track()
        track.set_number('16')
        track.set_title('Call It Fate')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Richie Dan')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('17')
        track.set_title('A Little Bit Of Luck')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('DJ Luck & MC Neat')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('18')
        track.set_title('I Want You')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Rosie Gaines')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('11')
        track.set_title('Baby Gonna Rock Dis')
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Chris Mack')
        track_artist.set_various(False)
        ...
        s = discogs.ReleaseScraper.from_string('http://www.discogs.com/Various-Pure-Silk-The-Third-Dimension/release/463634')
        r = s.get_result()
...
class MusicbrainzTest(TestCase):
    ...
    def test_multiple_cds(self):
        ...
        track.set_length(351)
        track_artist = expected.create_artist()
        track_artist.set_name(u'ASP')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        track_artist.set_name(u'Chamber')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
    ...
    def test_medium_in_sub_heading(self):
        ...
        track = disc.create_track()
        track.set_number(u'6')
        track.set_title(u'Gangstarism (feat. Goldfish)')
        track.set_length(251)
        disc.append_track(track)

        track = disc.create_track()
        track.set_number(u'7')
        track.set_title(u'Young Thugs (feat. Ghetto E & Lori)')
        ...
        track = disc.create_track()
        track.set_number(u'12')
        track.set_title(u'Shadows (feat. Kalonda & Ryan)')
        track.set_length(242)
        disc.append_track(track)
