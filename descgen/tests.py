...
class DiscogsTest(TestCase):
    ...
    def test_featuring_track_artist_in_artist_column(self):
        ...
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Mike Moonight')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
        ...
        track.set_length(None)
        track_artist = expected.create_artist()
        track_artist.set_name('Franklin Rodrigues')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        track_artist = expected.create_artist()
...
class MusicbrainzTest(TestCase):
    ...
    def test_dvd_and_cd_in_sub_heading(self):
        ...
        track = disc.create_track()
        track.set_number('2')
        track.set_title('COLORS')
        track.set_length(219)
        track_artist = expected.create_artist()
        track_artist.set_name('FLOW')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track.set_length(262)
        track_artist = expected.create_artist()
        track_artist.set_name('ALI PROJECT')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track.set_length(278)
        track_artist = expected.create_artist()
        track_artist.set_name('SunSet Swish')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track.set_length(238)
        track_artist = expected.create_artist()
        track_artist.set_name('ORANGE RANGE')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
        ...
        track = disc.create_track()
        track.set_number('11')
        track.set_title('WORLD END type1')
        track.set_length(93)
        track_artist = expected.create_artist()
        track_artist.set_name('FLOW')
        track_artist.set_various(False)
        ...
        track = disc.create_track()
        track.set_number('12')
        track.set_title('WORLD END type2')
        track.set_length(93)
        track_artist = expected.create_artist()
        track_artist.set_name('FLOW')
        track_artist.set_various(False)
...
class JunodownloadTest(TestCase):
    ...
    def test_release_with_broken_html(self):
        expected = ReleaseResult()
        expected.set_scraper_name(None)

        release_event = expected.create_release_event()
        release_event.set_date('26 June, 2013')
        release_event.set_country(None)
        expected.append_release_event(release_event)
        ...
        label_id = expected.create_label_id()
        label_id.set_label('Clubstar Germany')
        label_id.append_catalogue_nr('CLS 0002952D')
        expected.append_label_id(label_id)

        expected.set_title('Coco Beach Ibiza Vol 2')

        artist = expected.create_artist()
        artist.set_name('Paul Lomax')
        artist.set_various(False)
        artist.append_type(expected.ArtistTypes.MAIN)
        expected.append_release_artist(artist)

        artist = expected.create_artist()
        artist.set_name('Tom Pool')
        artist.set_various(False)
        artist.append_type(expected.ArtistTypes.MAIN)
        expected.append_release_artist(artist)
        ...
        expected.set_url('https://secure.junodownload.com/products/80-reggae-love-song-anthems/2225145-02/')
        ...
        track = disc.create_track()
        track.set_number('1')
        track.set_title('Various - Coco Beach Ibiza Vol 2 Bonus Mix 1 (continuous mix by Paul Lomax)')
        track.set_length(4216)
        disc.append_track(track)

        track = disc.create_track()
        track.set_number('2')
        track.set_title('Various - Coco Beach Ibiza Vol 2 Bonus Mix 2 (continuous mix by Tom Pool)')
        track.set_length(3878)
        disc.append_track(track)

        track = disc.create_track()
        track.set_number('3')
        track.set_title('Marc Vexar - Changes')
        track.set_length(480)
        disc.append_track(track)

        track = disc.create_track()
        track.set_number('4')
        track.set_title('Novika - Miss Mood (Satin Jackets remix)')
        track.set_length(480)
        disc.append_track(track)

        track = disc.create_track()
        track.set_number('5')
        track.set_title('Crazy P - Eruption (Bonar Bradberry remix)')
        track.set_length(393)
        disc.append_track(track)

        track = disc.create_track()
        track.set_number('6')
        track.set_title("Mark Bale - You (feat Stella O'Neil - Funky Dice & Dezibl remix radio edit)")
        track.set_length(469)
        disc.append_track(track)

        track = disc.create_track()
        track.set_number('7')
        track.set_title('Kruse & Nuernberg - For My Life (feat Stee Downes)')
        track.set_length(269)
        disc.append_track(track)

        track = disc.create_track()
        track.set_number('8')
        track.set_title('Bruno From Ibiza - This Is Your Life (feat Simonne Cooper)')
        track.set_length(340)
        disc.append_track(track)

        track = disc.create_track()
        track.set_number('9')
        track.set_title('David K - Open Eyes (feat Marie Chain - Sonik remix)')
        track.set_length(443)
        disc.append_track(track)

        track = disc.create_track()
        track.set_number('10')
        track.set_title("Luca Citoli - If I Can't")
        track.set_length(454)
        disc.append_track(track)

        track = disc.create_track()
        track.set_number('11')
        track.set_title('Luciano - Rise Of Angel (Andrea Oliva remix)')
        track.set_length(493)
        disc.append_track(track)

        track = disc.create_track()
        track.set_number('12')
        track.set_title('Alexandros Djkevingr - Kingdom Of Parsley (HP Hoeger & Paul Lomax Balearic Beach mix)')
        track.set_length(421)
        disc.append_track(track)

        track = disc.create_track()
        track.set_number('13')
        track.set_title('Fred Falke - 909 PM At The Beach')
        track.set_length(390)
        disc.append_track(track)

        track = disc.create_track()
        track.set_number('14')
        track.set_title('Dan Caster & Toby Montana - Babylon Beach')
        track.set_length(380)
        disc.append_track(track)

        track = disc.create_track()
        track.set_number('15')
        track.set_title("Lefa Sammy Mkhabela (Cannon-Soul) - Aladura (Andy's & Nteeze remix)")
        track.set_length(452)
        disc.append_track(track)

        track = disc.create_track()
        track.set_number('16')
        track.set_title('Dan Caster - Marlene (original version)')
        track.set_length(420)
        disc.append_track(track)

        track = disc.create_track()
        track.set_number('17')
        track.set_title('Edu Imbernon & Los Suruba - Leopard (feat Daniel Wilde - Sascha Braemer & Dan Caster remix)')
        track.set_length(358)
        disc.append_track(track)

        track = disc.create_track()
        track.set_number('18')
        track.set_title('Nicone & Sascha Braemer - Raoui (feat Narra - original version)')
        track.set_length(401)
        disc.append_track(track)

        track = disc.create_track()
        track.set_number('19')
        track.set_title('Riva Starr - Absence (feat RSSLL - Adam Port remix)')
        track.set_length(460)
        disc.append_track(track)

        track = disc.create_track()
        track.set_number('20')
        track.set_title('Super Flu - Super Flu 3 < Isaac')
        track.set_length(506)
        disc.append_track(track)

        track = disc.create_track()
        track.set_number('21')
        track.set_title('Douglas Greed - This Time (feat Kuss)')
        track.set_length(500)
        disc.append_track(track)

        track = disc.create_track()
        track.set_number('22')
        track.set_title('Raone Franco & Salla - Secrets (feat Luckwhere - Kyrill & Redford remix)')
        track.set_length(367)
        disc.append_track(track)

        expected.append_disc(disc)
        s = junodownload.ReleaseScraper.from_string('https://secure.junodownload.com/products/80-reggae-love-song-anthems/2225145-02/')
        r = s.get_result()
...
class ITunesTest(TestCase):
    ...
    def test_simple_album(self):
        ...
        track_artist = expected.create_artist()
        track_artist.set_name('The Cult')
        track_artist.set_various(False)
        track_artist.append_type(expected.ArtistTypes.MAIN)
        track.append_artist(track_artist)
        disc.append_track(track)
